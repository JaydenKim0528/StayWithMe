        ...
        http    //authorizeHttpRequests 어떤 요청에 대해 어떤 권한이 필요한지 설정
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 인증 없이 접근 가능
                                ...
                                .requestMatchers("/tour","/hotel-single/**", "/date-search").permitAll()
                                ...
                                .requestMatchers("/seller-main.do", "/reservation.do", "/reservation-search.do", "/reservation-daily.do", "/reservation-monthly.do", "/basic-rate-list.do", "/getRoomRates", "/basic-rate-write.do", "/season-period.do", "/extra-delete", "/periods-update", "/reservation-monthly-data", "/modify").hasRole("ACCOMMODATION_ADMIN") // 일반유저 권한을 가진 사용자만 접근 (추후 수정)
