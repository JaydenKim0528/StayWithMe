        ...
        http    //authorizeHttpRequests 어떤 요청에 대해 어떤 권한이 필요한지 설정
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 인증 없이 접근 가능
                                ...
                                .requestMatchers("/tour","/hotel-single/**", "/apply-coupon").permitAll()
                                .requestMatchers("/enroll", "/save-location", "/couponList", "/addCoupon", "/add-all","/complete","/refund").permitAll()
                                .requestMatchers("/static/**", "/web-login", "/reservation", "/reserve-save", "/payment", "/payments/complete").permitAll()
